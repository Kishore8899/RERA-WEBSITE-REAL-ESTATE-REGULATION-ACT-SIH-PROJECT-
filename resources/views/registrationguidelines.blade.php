...
<table class="table table-bordered">
	<tr>
		<td><img src="{{URL::asset('/image/1.jpg')}}"  align="left" height="52" width="52"></td>
	...
	<tr>
		<td><img src="{{URL::asset('/image/2.jpg')}}"  align="left" height="52" width="52"></td>
	...
	<tr>
		<td><img src="{{URL::asset('/image/3.jpg')}}"  align="left" height="52" width="52"></td>
