...
<br>
<div class="jumbotron " style="text-align:justify;background-color:white;opacity: 0.90;">
<div class="row">
<div class="col-sm-6">
<h3><span class="glyphicon glyphicon-asterisk"></span>Our philosophy</h3>
...
<div class="row">
<div class="col-sm-6">
<p><h4><span class="glyphicon glyphicon-asterisk"></span>Trust</h4> DxRERA helps developers in building credibility and go a long way in establishing a relationship of trust with the customers. </p><br><br>
<p><h4><span class="glyphicon glyphicon-asterisk"></span>Control</h4>DxRERA provisions would ensure stricter control on management of funds and timely delivery of projects by the developers / promoters. </p>
</div>
<div class="col-sm-6">
<p><h4><span class="glyphicon glyphicon-asterisk"></span>Transparency</h4>DxRERA creates a more equitable & fair transaction between the consumer and developer / promoter thus ensuring a positive environment in the real estate sector. </p><br>
<p><h4><span class="glyphicon glyphicon-asterisk"></span>Credibility</h4>DxRERA will facilitate the consumer while boosting the credibility of developers.</p>
</div>
</div>
</div>
<div class="col-sm-6">
<h3>MAGNIFYING towards...</h3>
<p >
...
<p><h4>DELHI <br>REAL ESTATE REGULATORY AUTHORITY</h4></p> <br><br><br><br><br><br>
</div>
</div>
<div class="col-sm-6">
